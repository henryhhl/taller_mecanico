...
class CreateArticulo extends Component {
    ...
    get_data() {
        axios.get( web.servidor + '/articulo/create').then(
            (response) => {
    ...
    onSubmit() {
        ...
        axios(
            {
                method: 'post',
                url: web.servidor + '/articulo/store',
                data: formdata,
                headers: {
...
CreateArticulo.propTypes = {
    buttoncolor: PropTypes.string,
}

CreateArticulo.defaultProps = {
    buttoncolor: '',
}

export default withRouter(CreateArticulo);
