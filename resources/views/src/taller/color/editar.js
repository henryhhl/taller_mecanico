...
class EditarVehiculoColor extends Component {
    ...
    get_data() {
        axios.get( web.servidor + '/vehiculo_color/edit/' + this.props.match.params.id).then(
            (response) => {
    ...
    onSubmit() {
        ...
        axios(
            {
                method: 'post',
                url: web.servidor + '/vehiculo_color/update',
                data: formdata,
                headers: {
...
EditarVehiculoColor.propTypes = {
    buttoncolor: PropTypes.string,
}

EditarVehiculoColor.defaultProps = {
    buttoncolor: '',
}

export default withRouter(EditarVehiculoColor);
