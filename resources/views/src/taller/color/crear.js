...
class CreateVehiculoColor extends Component {
    ...
    get_data() {
        axios.get( web.servidor + '/vehiculo_color/create').then(
            (response) => {
...
CreateVehiculoColor.propTypes = {
    buttoncolor: PropTypes.string,
}

CreateVehiculoColor.defaultProps = {
    buttoncolor: '',
}

export default withRouter(CreateVehiculoColor);
