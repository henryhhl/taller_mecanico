...
class EditarVehiculoModelo extends Component {
    ...
    get_data() {
        axios.get( web.servidor + '/vehiculo_modelo/edit/' + this.props.match.params.id).then(
            (response) => {
                if (response.status == 200) {
                    ...
                    if (response.data.response == 1) {
                        ...
                        this.setState({
                            array_marca: response.data.vehiculomarca,
                            descripcion: response.data.data.descripcion,
                            marca: { id: response.data.data.id, descripcion: response.data.data.marca },
                        });
                        return;
                    }
                }
    ...
    onSubmit() {
        ...
        axios(
            {
                method: 'post',
                url: web.servidor + '/vehiculo_modelo/update',
                data: formdata,
                headers: {
                ...
                if (response.status == 200) {
                    if (response.data.response == 1) {
                        notification.success({
                            message: 'SUCCESS',
                            description: 'MODELO DE MARCA ACTUALIZADO EXITOSAMENTE',
                        });
                        this.props.history.goBack();
                    }
                    if (response.data.response == -1) {
...
EditarVehiculoModelo.propTypes = {
    buttoncolor: PropTypes.string,
}

EditarVehiculoModelo.defaultProps = {
    buttoncolor: '',
}

export default withRouter(EditarVehiculoModelo);
