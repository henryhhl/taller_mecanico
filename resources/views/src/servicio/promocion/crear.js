...
class CreatePromocion extends Component {
    ...
    get_data() {
        axios.get( web.servidor + '/promocion/create').then(
            (response) => {
    ...
    onSubmit() {
        ...
        axios(
            {
                method: 'post',
                url: web.servidor + '/promocion/store',
                data: formdata,
                headers: {
            ...
            response => {
                ...
                if (response.data.response == 1) {
                    notification.success({
                        message: 'SUCCESS',
                        description: 'PROMOCION CREADO EXITOSAMENTE',
                    });
                    this.props.history.goBack();
                }
                if (response.data.response == -1) {
...
CreatePromocion.defaultProps = {
    buttoncolor: '',
}

export default withRouter(CreatePromocion);
