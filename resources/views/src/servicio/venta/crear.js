...
class CreateVenta extends Component {
    ...
    componentDidMount() {
        ...
        if (this.props.venta.create == 1) {
            ...
            this.setState({
                ...
                codigo: this.props.venta.codigo,
                observaciones: this.props.venta.observaciones,
                cliente_first: this.props.venta.cliente_first,
                vehiculo_first: this.props.venta.vehiculo_first,
                mecanico_first: this.props.venta.mecanico_first,
                array_serviciosselected: this.props.venta.array_serviciosselected,
                array_articulo: this.props.venta.array_articulo,
                descuento: this.props.venta.descuento,
                key: this.props.venta.key,
            }, () => this.ongenerarTotal() );
            setTimeout(() => {
                this.props.initventa();
            }, 500);
            return;
        }
        this.get_data();
    ...
    get_data() {
        axios.get( web.servidor + '/venta/create').then(
            (response) => {
                ...
                <div className='cols-lg-7 cols-md-7 cols-sm-12 cols-xs-12 txts-center'>
                    ...
                    <div className="forms-groups">
                        ...
                        <div className='cols-lg-3 cols-md-3 cols-sm-12 cols-xs-12'>
                            <button className="btn-hover-shine btn btn-light btn-lg btn-block mt-1"
                                onClick={() => this.get_cliente(1, this.state.search_cliente)}
                    ...
                    <div className="forms-groups" style={{marginTop: 10}}>
                        <Card title="VEHICULO DEL CLIENTE" bodyStyle={{padding: 0,}}
                            extra={ this.state.cliente_first.idcliente != null ?
                                <button className="btn-hover-shine btn btn-primary pull-right"
                                    onClick={() => {
                                        this.props.ventacreate(this.ondataventa());
                                        setTimeout(() => {
                                            this.props.history.push('/taller_mecanico/vehiculo/create');
                                        }, 500);
                                    }}
                                    style={{fontSize: 10, }}
                                >
                                ...
                                {this.state.array_vehiculo.map(
                                    (data, key) => (
                                        <div className='cols-lg-12 cols-md-12 cols-sm-12 cols-xs-12' 
                                            ...
                                            onClick={this.onIDVehiculo.bind(this, data)}
                                        >
                            ...
                            <div className='inputs-groups'>
                                ...
                                {this.state.cliente_first.idcliente == null ? null : 
                                    <button className="btn-hover-shine btn btn-sm btn-danger fa fa-close"
                                        ...
                                        onClick={this.onDeleteCliente.bind(this)}
                                    ></button>
                                }
                                <Tooltip placement='top' title='NUEVO CLIENTE'>
                                    <button className="btn-hover-shine btn btn-sm btn-secondary fa fa-plus"
                        ...
                        <div className='cols-lg-4 cols-md-4 cols-sm-12 cols-xs-12'>
                            <div className='inputs-groups'>
                                <input type='text'
                                    ...
                                    onChange={this.onChangeNitCliente.bind(this)}
                                    readOnly={this.state.cliente_first.idcliente == null ? true : false}
                                    style={{background: this.state.cliente_first.idcliente == null ? '#eee' : 'transparent',
                                        cursor: this.state.cliente_first.idcliente == null ? 'default' : 'text'
                                    }}
                                />
                        ...
                        <div className='cols-lg-12 cols-md-12 cols-sm-12 cols-xs-12'>
                            <div className='inputs-groups'>
                                <input type='text'
                                    ...
                                    onChange={this.onChangeEmailCliente.bind(this)}
                                    readOnly={this.state.cliente_first.idcliente == null ? true : false}
                                    style={{background: this.state.cliente_first.idcliente == null ? '#eee' : 'transparent',
                                        cursor: this.state.cliente_first.idcliente == null ? 'default' : 'text'
                                    }}
                        ...
                        <div className='cols-lg-12 cols-md-12 cols-sm-12 cols-xs-12'>
                            <div className='inputs-groups'>
                                <textarea type='text' placeholder='Ingresar Descripcion' 
                                    ...
                                    className={`forms-control`} 
                                    value={'OJO: Hacer Click en el Vehiculo de la Izq. para generar los datos.'}
                                    readOnly
                                />
                            </div>
                        </div>
            ...
            <div className="forms-groups" style={{ marginTop: 20, }}>
                ...
                <div className='cols-lg-12 cols-md-12 cols-sm-12 cols-xs-12' style={{paddingBottom: 0, paddingTop: 0, }}>
                    <div className='cols-lg-6 cols-md-6 cols-sm-12 cols-xs-12' style={{paddingBottom: 0, paddingTop: 0, }}>
                        ...
                        <div className='cols-lg-6 cols-md-6 cols-sm-12 cols-xs-12' style={{paddingRight: 0,}}>
                            <div className='inputs-groups'>
                                <input type='text'
                                    className={`forms-control`}
                                    value={this.state.search_mecanico}
                                    placeholder='Search Mecanico...'
                                    onChange={ (event) => this.setState({search_mecanico: event.target.value,}) }
                                />
                            </div>
                        </div>
                        <div className='cols-lg-2 cols-md-2 cols-sm-12 cols-xs-12'>
                            <button className="btn-hover-shine btn btn-light btn-lg btn-block mt-1"
                                onClick={() => this.get_mecanico(1, this.state.search_mecanico)}
                                style={{paddingLeft: 0, paddingRight: 0, display: 'flex', justifyContent: 'center', fontSize: 10, }}
                            >
                                BUSCAR
                            </button>
                                            ...
                                            return (
                                                <tr key={key} style={error}>
                                                    <td style={{cursor: 'default', position: 'relative', }}>
                                                        ...
                                                        <Popconfirm placement='top' title='ESTAS SEGURO DE ELIMINAR LA FILA?'
                                                            okText='SI' cancelText='NO' onConfirm={this.onDeleteRow.bind(this, key)}
                                                        >
                                                            <Tooltip title='ELIMINAR' placement='top'>
                                                                <i className='fa fa-trash red_hover' 
                                                                    style={{fontSize: 18, position: 'absolute', top: 4, right: 5, cursor: 'pointer',
                                                                        padding: 3, paddingLeft: 2, paddingRight: 2, color: 'red', 
                                                                    }}
                                                                ></i>
                                                            </Tooltip>
                                                        </Popconfirm>
                                                                            ...
                                                                            <div style={{textAlign: 'center', paddingBottom: 5,}}>
                                                                                <div className='inputs-groups' style={{width: 150, }}>
                                                                                    <input type='text' placeholder=''
                                                                                        ...
                                                                                        value={data.cantidad}
                                                                                        onChange={this.onChangeCantidad.bind(this, data)}
                                                                                    />
                                                                    ...
                                                                    <div style={{textAlign: 'center', paddingBottom: 5,}}>
                                                                        <div className='inputs-groups' style={{width: 150, }}>
                                                                            <input type='text' placeholder=''
                                                                                ...
                                                                                style={{paddingRight: 25, color: '#1890ff', }}
                                                                                value={data.precio}
                                                                                onChange={this.onChangePrecio.bind(this, data)}
                                                                            />
                                                                            <i className='fa fa-angle-up blue_hover' 
                                                                                style={{fontSize: 14, position: 'absolute', top: 3, right: 5, cursor: 'pointer',
                                                                                    padding: 0, paddingLeft: 2, paddingRight: 2, 
                                                                                }}
                                                                                onClick={this.onPrecioIncrementar.bind(this, data)}
                                                                            ></i>
                                                                            <i className='fa fa-angle-down blue_hover' 
                                                                                style={{fontSize: 14, position: 'absolute', bottom: 3, right: 5, cursor: 'pointer',
                                                                                    padding: 0, paddingLeft: 2, paddingRight: 2, 
                                                                                }}
                                                                                onClick={this.onPrecioDecrementar.bind(this, data)}
                                                                            ></i>
                                                                        </div>
                                                                    </div>
                                                                    <div style={{textAlign: 'center', }}>
                                                    ...
                                                    <div style={{textAlign: 'center', paddingBottom: 5,}}>
                                                        <div className='inputs-groups' style={{width: 150, }}>
                                                            <input type='text' placeholder=''
                                                                ...
                                                                onChange={this.onChangeDescuentoGral.bind(this)}
                                                            />
                                                            <i className='fa fa-angle-up blue_hover' 
                                                                style={{fontSize: 14, position: 'absolute', top: 3, right: 5, cursor: 'pointer',
                                                                    padding: 0, paddingLeft: 2, paddingRight: 2, 
                                                                }}
                                                                onClick={this.onDescuentoIncrementarGral.bind(this)}
                                                            ></i>
                                                            <i className='fa fa-angle-down blue_hover' 
                                                                style={{fontSize: 14, position: 'absolute', bottom: 3, right: 5, cursor: 'pointer',
                                                                    padding: 0, paddingLeft: 2, paddingRight: 2, 
                                                                }}
                                                                onClick={this.onDescuentoDecrementarGral.bind(this)}
                                                            ></i>
                                                        </div>
                                                    </div>
                                                    <div style={{textAlign: 'center', }}>
                        ...
                        <div className='forms-groups'>
                            <div className="forms-groups">
                                <Card
                                    ...
                                    extra={ 
                                        <div>
                                            <Tooltip placement='top' title='NUEVO MECANICO'>
                                                <button className="btn-hover-shine btn btn-sm btn-outline-alternate rounded-circle mr-2 fa fa-wrench" //odnoklassniki
                                                    style={{fontSize: 17, padding: 5, paddingLeft: 7, paddingRight: 7, }}
                                                    onClick={() => {
                                                        this.props.ventacreate(this.ondataventa());
                                                        setTimeout(() => {
                                                            this.props.history.push( web.serv_link + '/mecanico/create');
